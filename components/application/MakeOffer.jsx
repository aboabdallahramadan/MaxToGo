...
const MakeOffer = ({task}) => {
  ...
  return (
    <>
        <button className="py-2 px-4 text-lg text-foreground border border-primary hover:text-secondary hover:bg-primary rounded-xl" onClick={purchaseTask}>{t("OfferAPrice")}</button>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-secondary p-6 rounded-lg shadow-lg w-full max-w-md flex flex-col justify-start gap-6 items-center">
            ...
            <div className="flex justify-start gap-4 items-start">
              ...
              <h2 className="text-lg font-bold mb-4">{t("ConfirmPurchase" , {action: t("offer"), type: task.type , price: t("NewPrice")})} ?</h2>
            </div>
            ...
            <div className="mb-4 w-full">
                <div className="flex justify-start gap-2 items-center mb-2">
                    <FaMoneyBill className="text-primary text-lg"/>
