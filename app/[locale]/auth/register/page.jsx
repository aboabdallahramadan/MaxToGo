...
import MustRead from "@/components/auth/MustRead";
...
const page = () => {
  ...
  const tTerms = useTranslations("Auth.Terms");
  const tRamavtal = useTranslations("Auth.ramavtal");
  ...
  const validateForm = () => {
    ...
    if (pageNumber === 0) {
      ...
      if (!formData.policy) {
        ...
        newErrors.ramavtal = t("PleaseAcceptTerms");
      }
      if (!formData.ramavtal) {
        newErrors.ramavtal = t("PleaseAcceptTerms");
      }
    }
      ...
      <div className="w-4/5">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className={pageNumber == 3 ? "block" : "hidden"}>
            <div className="mt-6">
              <MustRead name={"policy"} t0={tTerms} t={t} formData={formData} handleInputChange={handleInputChange} errors={errors}/>
              <MustRead name={"ramavtal"} t0={tRamavtal} t={t} formData={formData} handleInputChange={handleInputChange} errors={errors}/>
            </div>
